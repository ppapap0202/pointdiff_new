...
$tag = "train_pos8_compete8_bgtopk32_v1_from0551_bs32"
$config = Join-Path $RepoRoot "config\train_density_only_prior_t50_conf_add64_localcomp_r3_pos8_compete8_bgtopk32_v1_from_epoch0551_to0651_bs32.yaml"
...
$outDir = "D:\output\density_only_prior_t50_conf_add64_localcomp_r3_pos8_compete8_bgtopk32_v1_from_epoch0551_to0651_bs32_ddim5_nonms"
...
@(
    ...
    "experiment=rand_bg_topk=32 hard negative mining, lambda_rand_bg 10.0->2.0 (magnitude-matched)",
    "baseline=pos8_compete8 (same 0551 start, unweighted bg mean) FAILED: recall 0.4118->0.3641, mae 109->133.7",
    "watch=val_conf_no_nms_precision@6 should rise (far-background FP), val_conf_no_nms_recall@6 is the risk"
