...
$tag = "train_pos8_compete8_v1_from0551_bs32"
$config = Join-Path $RepoRoot "config\train_density_only_prior_t50_conf_add64_localcomp_r3_pos8_compete8_v1_from_epoch0551_to0651_bs32.yaml"
...
$outDir = "D:\output\density_only_prior_t50_conf_add64_localcomp_r3_pos8_compete8_v1_from_epoch0551_to0651_bs32_ddim5_nonms"
...
@(
    ...
    "experiment=exist_pos_radius 32->8, rand_soft_compete radius 32->8 / winner 32->6",
    "baseline=groupassign_pos32 (exist_pos_radius=32) stopped at epoch 0569",
